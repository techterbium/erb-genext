...
export default class DashPlayer extends React.Component {
  componentDidMount() {
    ...
    // const url = 'https://media.axprod.net/TestVectors/v7-MultiDRM-SingleKey/Manifest_1080p_ClearKey.mpd';
    const url = 'https://dash.akamaized.net/akamai/bbb_30fps/bbb_30fps.mpd';
    console.log('Dash initializing...', this.player);
    ...
    // dashjsplayer.setProtectionData(keyData1);
